// Optional addition in future versions. Keep in mind that google does not like foundation for some reason -_-
// Terrible mistake on my part. Foundation will raise "Compromise Site" flags on google.
!(function (t, e) {
                ...
                value: function (t) {
                  ...
                  i.length &&
                    (void 0 === t.attr("aria-describedby") &&
                      (void 0 === (e = s.attr("id")) &&
                        ((e = Object(r.GetYoDigits)(6, "abide-error")),
                        s.attr("id", e)),
                      t.attr("aria-describedby", e)),
                    o.filter("[for]").length < o.length &&
                      (void 0 === (n = t.attr("id")) &&
                        ((n = Object(r.GetYoDigits)(6, "abide-input")),
                        t.attr("id", n)),
                      o.each(function (t, e) {
                        e = c()(e);
              ...
              },
              {
                ...
                value: function (e) {
                  ...
                  switch (e[0].type) {
                    ...
                    default:
                      t || s.push("required"),
                        this.validateText(e) || s.push("pattern");
                  }
                  o &&
                    ((n = !!e.attr("required")),
                    ...
                    e.attr("data-equalto") &&
                      (this.options.validators.equalTo(e) || s.push("equalTo"));
                  var a,
                    l = 0 === s.length,
                ...
                value: function () {
                  ...
                  this.$tabs.each(function () {
                    ...
                    this.options.deepLink &&
                      s()(window).on("hashchange", this._checkDeepLink);
                },
              },
              {
                key: "toggle",
              ...
              },
              {
                ...
                value: function () {
                  this.$element
                    ...
                    this.options.deepLink &&
                      s()(window).off("hashchange", this._checkDeepLink);
                },
              },
            ]) && u(t.prototype, e),
            n && u(t, n),
          ...
          function n(t, e) {
            ...
            (this.uuid = Object(o.GetYoDigits)(6, e)),
              this.$element.attr("data-".concat(e)) ||
                this.$element.attr("data-".concat(e), this.uuid),
                    ...
                    .on("keydown.zf.drilldown", function (e) {
                      ...
                      s.each(function (t) {
                        r()(this).is(o) &&
                          ...
                          (i = s.eq(Math.min(t + 1, s.length - 1))));
                      }),
                ...
                value: function (e, n) {
                  ...
                  o.each(function (t) {
                    0 === t &&
                      ...
                      i.$wrapper.css("height", r()(this).data("calcHeight"));
                    t = t === o.length - 1;
                    !0 == t &&
                      r()(this).one(
                        Object(l.transitionend)(r()(this)),
                        function () {
                          !0 === n && e.find("li > a").first().focus();
                        }
                      ),
                ...
                value: function () {
                  ...
                  return (
                    this.$submenus.add(this.$element).each(function () {
                      ...
                      (e = e < t ? t : e),
                        n.options.autoHeight && r()(this).data("calcHeight", t);
                    }),
                    this.options.autoHeight
            ...
            (e = [
                    ...
                    void 0 === this.$element.attr("aria-labelledby") &&
                      (void 0 === this.$currentAnchor.attr("id") &&
                        this.$currentAnchor.attr(
                          "id",
                          Object(a.GetYoDigits)(6, "dd-anchor")
                        ),
                      this.$element.attr(
                        "aria-labelledby",
              ...
              },
              {
                ...
                value: function () {
                  ...
                  return t
                    ? t[1]
                    : d(m(o.prototype), "_getDefaultAlignment", this).call(
                        this
                      );
                },
              },
                ...
                value: function () {
                  ...
                  this.$element.trigger(
                    ...
                    !this.options.autoFocus ||
                      ((t = r.Keyboard.findFocusable(this.$element)).length &&
                        t.eq(0).focus()),
              ...
              },
              {
                ...
                value: function () {
                  return (
                    ...
                    (Object(a.rtl)() && !this.$element.hasClass("align-left"))
                  );
                },
              },
              {
                        ...
                        n &&
                          (i
                            ...
                            : (t.stopImmediatePropagation(),
                              ...
                              f._show(o),
                              e
                                .add(e.parentsUntil(f.$element, ".".concat(r)))
                ...
                value: function () {
                  ...
                  this.options.equalizeOn
                    ...
                    ((void 0 !== n && !1 === n) || void 0 === n) &&
                      (t.length
                        ? Object(r.onImagesLoaded)(t, this._reflow.bind(this))
                        : this._reflow());
                },
              },
              {
                ...
                value: function () {
                  for (var t in r.MediaQuery.queries)
                    r.MediaQuery.queries.hasOwnProperty(t) &&
                      ...
                      (s.SPECIAL_QUERIES[t.name] = t.value));
                },
              },
              {
                key: "_generateRules",
          ...
          return (
            ...
            (e = [
              ...
              },
              {
                ...
                value: function () {
                  var t =
                    this.$element[0].id || Object(r.GetYoDigits)(6, "magellan");
                  ...
                  this._inTransition ||
                    ...
                    void 0 !== s
                      ? ((this.$active = this.$links.filter(
                          '[href="#' +
                            this.$targets.eq(s).data("magellan-target") +
                            '"]'
                        )),
                        this.$active.length &&
                          (i = this.$active[0].getAttribute("href")))
                      : (this.$active = a()()),
                    (o = !(
                      (!this.$active.length && !t.length) ||
                      this.$active.is(t)
                    )),
            ...
            (e = [
              {
                ...
                value: function (t, e) {
                  ...
                  (this.className = "OffCanvas"),
                    ...
                    s()(["left", "right", "top", "bottom"]).each(function (
                      t,
                      e
                    ) {
              ...
              },
              {
                ...
                value: function () {
                  ...
                  e &&
                    ...
                    (this.options.revealOn = this.options.revealOn || e[1])),
                      ...
                      function () {
                        t.$element.addClass("is-closed"),
                          ...
                          !0 === t.options.trapFocus &&
                            ...
                            l.Keyboard.releaseFocus(t.$element)),
              ...
              },
              {
                ...
                value: function () {
                  ...
                  var t = this.$element.find("img"),
                    ...
                    n =
                      this.$element[0].id || Object(u.GetYoDigits)(6, "orbit");
              ...
              },
              {
                ...
                value: function () {
                  this._alignmentsExhausted(this.position)
                    ? ((this.position = p(this.position, d)),
                  ...
                  value: function (t, e) {
                    (this.$element = u()(t)),
                      ...
                      this.$element.attr("id") ||
                        this.$element.attr(
                          "id",
                          Object(c.GetYoDigits)(6, "responsiveaccordiontabs")
                        ),
                      this._init(),
                      this._events();
                  },
                        ...
                        : "tabs" === t &&
                          ...
                          o.each(function (t, e) {
                            var n = u()(e).appendTo(l).addClass(s),
                              ...
                              o =
                                u()(e).attr("id") ||
                                Object(c.GetYoDigits)(6, "accordion");
                            i !== o &&
                              ("" !== i
                                ? u()(e).attr("id", i)
                                : ((i = o),
                    ...
                    s.a.isEmptyObject(this.rules) || this._checkMediaQueries(),
                      this.$element.attr(
                        ...
                        this.$element.attr("data-mutate") ||
                          Object(a.GetYoDigits)(6, "responsive-menu")
                      );
                  },
                },
                {
            ...
            (e = [
              ...
              },
              {
                ...
                value: function () {
                  ...
                  u.MediaQuery._init(),
                    ...
                    (this.$anchor = s()('[data-open="'.concat(this.id, '"]'))
                      .length
                    ...
                    this.$overlay
                      ...
                      : (this.$element
                          .detach()
                          .appendTo(s()(this.options.appendTo)),
                ...
                value: function () {
                  ...
                  this.$element.on({
                    ...
                    "close.zf.trigger": function (t, e) {
                      if (
                        t.target === i.$element[0] ||
                        s()(t.target).parents("[data-closable]")[0] === e
                      )
                ...
                value: function () {
                  ...
                  this.options.deepLink &&
                    ...
                    (window.history.pushState
                      ...
                      : (window.location.hash = e)),
                    (this.$activeAnchor = s()(document.activeElement).is(
                      this.$anchor
                    )
                  ...
                  this.options.animationIn
                    ? (this.options.overlay &&
                        c.Motion.animateIn(this.$overlay, "fade-in"),
                      c.Motion.animateIn(
                        this.$element,
                        this.options.animationIn,
                        function () {
                          t.$element &&
                            ((t.focusableElements = l.Keyboard.findFocusable(
                              t.$element
                            )),
                            n.$element
              ...
              },
              {
                ...
                value: function () {
                  var e = this;
                  this.$element &&
                    ((this.focusableElements = l.Keyboard.findFocusable(
                      this.$element
                    )),
                    this.options.overlay ||
                      !this.options.closeOnClick ||
              ...
              },
              {
                ...
                value: function () {
                  ...
                  this.options.animationOut
                    ? (this.options.overlay &&
                        c.Motion.animateOut(this.$overlay, "fade-out"),
                      c.Motion.animateOut(
                        this.$element,
                        this.options.animationOut,
                        n
                    ...
                    this.options.closeOnEsc &&
                      s()(window).off("keydown.zf.reveal"),
                    !this.options.overlay &&
                      this.options.closeOnClick &&
              ...
              },
              {
                ...
                value: function () {
                  this.options.overlay &&
                    (this.$element.appendTo(s()(this.options.appendTo)),
                ...
                value: function (t, e, n) {
                  ...
                  this.$element.hasClass(this.options.disabledClass) ||
                      ...
                      (e =
                        0 === this.handles.index(t)
                          ? (f = parseFloat(
                            ...
                            : e
                          : e <=
                            (r = parseFloat(this.$handle.attr("aria-valuenow")))
                          ? r + this.options.step
                          : e),
                    ...
                    Object(h.Move)(d, t, function () {
                      isNaN(l)
                        ? t.css(s, "".concat(100 * a, "%"))
                        : t.css(s, "".concat(l, "%")),
                        i.options.doubleSided
                          ? i.$fill.css(u)
                          : i.$fill.css(o, "".concat(100 * a, "%"));
                    }),
                    this.initialized &&
                ...
                value: function (t, e, n) {
                  ...
                  n
                    ...
                    : (t.preventDefault(),
                      ...
                      (e =
                        e ||
                        (g(this.$handle, o, a, i) <= g(this.$handle2, o, a, i)
                          ? this.$handle
                          : this.$handle2))),
            ...
            (e = [
              ...
              },
              {
                ...
                value: function () {
                  var t =
                    this.$element[0].id ||
                    Object(r.GetYoDigits)(6, "smooth-scroll");
              ...
              },
              {
                ...
                value: function () {
                  ...
                  var t = this.$element.parent("[data-sticky-container]"),
                    e =
                      this.$element[0].id || Object(r.GetYoDigits)(6, "sticky"),
                    n = this;
                  t.length
                    ? (this.$container = t)
                    : ((this.wasWrapped = !0),
                  ...
                  (this._isInitializing = !0),
                    ...
                    this.$tabTitles.each(function () {
                      ...
                      t.attr({ role: "presentation" }),
                        ...
                        n &&
                          r.options.autoFocus &&
                          (r.onLoadListener = Object(l.onLoad)(
                            a()(window),
                            function () {
                              a()("html, body").animate(
              ...
              },
              {
                ...
                value: function () {
                  ...
                  e.each(function (t, e) {
                    ...
                    new RegExp(
                      "\\b".concat(Object(l.RegExpEscape)(i), "\\b")
                    ).test(e) ||
                      n.attr(
                        "aria-controls",
                        e ? "".concat(e, " ").concat(i) : i
                      );
                  });
                },
              },
      ...
      "./js/foundation.util.box.js": function (t, e, n) {
        ...
        function s(t, e, n, i, o) {
          ...
          return (
            (t = e
              ? ((s =
                  (e = f(e)).height + e.offset.top - (t.offset.top + t.height)),
        ...
        function a(t) {
          return (
            ...
            t
              ...
              .sort(function (t, e) {
                if (o()(t).attr("tabindex") === o()(e).attr("tabindex"))
                  return 0;
        ...
        function s(t, e, n, i) {
          ...
          function r() {
            (e[0].style.transitionDuration = 0),
              e.removeClass("".concat(o, " ").concat(s, " ").concat(n));
          }
          (e = a()(e).eq(0)).length &&
            ((o = t ? u[0] : u[1]),
            (s = t ? c[0] : c[1]),
            ...
            c &&
              ...
              (n =
                ...
                o()(this)
                  ...
                  .trigger(
                    o.a.Event("swipe".concat(n), Object.assign({}, t))
                  )));
        }
        function p(t) {
          1 === t.touches.length &&
